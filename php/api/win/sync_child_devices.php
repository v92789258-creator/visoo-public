...
function cloud_device_folder_path($usuario_madre, $codigo_dispositivo) {
    $root = __DIR__ . DIRECTORY_SEPARATOR . 'new' . DIRECTORY_SEPARATOR . '_cloud_store';
...
function delete_device_snapshot_folder($usuario_madre, $codigo_dispositivo, &$message = '') {
    ...
    $store_root = __DIR__ . DIRECTORY_SEPARATOR . 'new' . DIRECTORY_SEPARATOR . '_cloud_store';
...
if ($action === 'list') {
    ...
    respond([
        ...
        'api_version' => 'sync_child_devices:old:2026-02-27-2'
    ]);
}
